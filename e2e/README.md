...
- `test_ten_validators.py` -- a ten-validator set: seven extra hotkeys
  attested next to the bootstrap's three in one update, a wrap spreading the
  deposit across all ten by weight, a full unwrap draining every slot.

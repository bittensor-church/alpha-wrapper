...
abstract contract AlphaVaultTestBase is AttestationHelper {
    ...
    /// @dev Storage slot of `AlphaVault._slots`, from `forge inspect AlphaVault storageLayout`.

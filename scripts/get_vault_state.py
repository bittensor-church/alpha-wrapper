...
def main() -> None:
    ...
    row = {
        ...
        "frozen_until": lens.functions.frozenUntil(token_id).call(block_identifier=block),
        "awaiting_attestation": lens.functions.awaitingAttestation(token_id).call(block_identifier=block),
